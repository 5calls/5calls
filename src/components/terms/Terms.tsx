    ...
    return (
      <main id="content" role="main" className="layout__main">
        <div className="about">
          ...
          <ul>
            ...
            <ul>
              <li>
                ...
                For those, call the first person on the list.
                When you’re done, enter your call results and then move to the next person on your list.
                Lather, rinse, repeat until you’re done.
              </li>
              <li>
                Some issues only need a call to your House rep; for others, just your senators.
                Again, we’ll make it clear who you should call.
              </li>
            </ul>
            <li>
          ...
          <p>
            It’s the fastest way to speak your mind.
            Call tallies are given to your member of Congress (MoC) on the regular,
            so the earlier you call about an issue, the more likely you are to sway them.
            If you can, call before your MoC takes a public stance on the issue,
            because once they do, they don't like to walk it back.
          </p>
          <h3>Can't I send an email/fax/letter/postcard instead?</h3>
          <p>
            Nope. Phone calls are tallied right away, so they have by far the most immediate impact.
            Faxes these days are typically rendered digitally via email.
            Emails and postal mail must be read, batched by issue and THEN tallied.
            Physical letters and postcards – yes, postcards too – may also be quarantined for safety inspections.
            (And if you think all that happens quickly, it …doesn’t.)
          </p>
          <h3>Do I need to make a separate call for each issue I care about?</h3>
          <p>
            Yes. Congressional insiders tell us call volume really matters.
            But because we know it seems weird to hang up and call right back about another issue,
            we’ve added reps’ district office numbers, too. That way you can at least talk to a different staffer.
          </p>
          <h3>What if the line is busy or the voicemail is full?</h3>
          <p>
            Congressional offices have been seeing record call volume since Donald Trump took office,
            and while it’s amazing that so many people care enough to call,
            we know it’s frustrating when you can’t get through. Don’t sweat it.
          </p>
          <p>The default number listed for each member of Congress (MoC) is their DC office,
            but we have their local office numbers, too. (In the iOS app, they’re under the “line busy?” link;
            in the Android app, they’re under the “call a local office” link.)
            If you’re leaving a voicemail, be sure to include your street address so your MoC
            knows you’re one of their constituents.
          </p>
          <p>
            If all else fails (or your MoCs are jerks who’ve shut down their phone lines), try tweeting at them,
            reaching them through their website, sending an email or sending a postcard.
            But these are absolute last resorts. Phone calls have the most impact by far.
          </p>
          <h3>Why call the House on issues only affecting the Senate (and vice versa)?</h3>
          <p>
            We want to show a clear display of general dissent (or support, depending on the issue).
            Even if they don’t directly vote on a particular issue, these people talk to each other,
            and they talk to the media. On top of that, your reps work for you. You can express support or dissent
            (politely, please) about whatever you want.
          </p>
          ...
          <p>
            If you can’t reach a live person or are punted to a voice mailbox, definitely.
            Voicemail is checked daily and tallied just like a call.
            Be sure to include your street address so your member of Congress will know
            you’re one of their constituents.
          </p>
          ...
          <p>
            ...
            so be sure to keep that info current.
          </p>
          <ul>
            <li>
              <strong>On the website:</strong>
