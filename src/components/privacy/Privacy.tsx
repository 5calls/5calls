...
const Privacy: React.StatelessComponent<Props> = (props: Props) => {
  return (
    <main id="content" role="main" className="layout__main">
      <p><a href="/">&laquo; Take me back to saving the nation</a></p>
      <p>Last updated: <strong>September 18, 2017</strong></p>
      <p> 5calls.org ("us", "we", or "our") operates the 5 Calls website (the "Service").</p>
      ...
      {/*tslint:disable-next-line:max-line-length*/}
      <p>Specifically, we use OneSignal to help us send notifications. You can find their <a href="https://onesignal.com/privacy_policy">privacy policy located here</a>.</p>
      ...
      {/*tslint:disable-next-line:max-line-length*/}
      <p>This Privacy Policy is effective as of September 18, 2017 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
      {/*tslint:disable-next-line:max-line-length*/}
      ...
      {/*tslint:disable-next-line:max-line-length*/}
      <p>If you have any questions about this Privacy Policy, please <a href={`mailto:${Constants.contact.email}`}>contact us</a>.</p>
    </main>
  );
};
