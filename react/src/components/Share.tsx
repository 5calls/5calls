...
class Share extends React.Component<null, State> {
  ...
  share(e: React.MouseEvent<HTMLAnchorElement>, type: string) {
    ...
    if (type === "facebook") {
      ...
      window.open(`https://threads.net/intent/post?text=${tweet}`, "sharewindow", "width=500, height=350");
    } else if (type === 'mastodon') {
      window.open(`https://mastodonshare.com/?text=${tweet}&url=5calls.org`, "sharewindow", "width=500, height=350");
    } else {
        ...
        <div className="share-links">
          <p className="share-bluesky">
            <a href="https://5calls.org" onClick={(e) => this.share(e, "bluesky")}>
              <i className="fa-brands fa-bluesky" aria-hidden="true"></i>Share on Bluesky
            </a>
          </p>
          <p className="share-threads">
            <a href="https://5calls.org" onClick={(e) => this.share(e, "threads")}>
              <i className="fab fa-threads" aria-hidden="true"></i>Share on Threads
            </a>
          </p>
          <p className="share-facebook">
            <a href="https://5calls.org" onClick={(e) => this.share(e, "facebook")}>
              <i className="fab fa-facebook" aria-hidden="true"></i>Share on Facebook
            </a>
          </p>
          <p className="share-mastodon">
            <a href="https://5calls.org" onClick={(e) => this.share(e, "mastodon")}>
              <i className="fab fa-mastodon" aria-hidden="true"></i>Share on Mastodon
            </a>
          </p>
        </div>
        </div>
